    ...
    public static class KingMovement
    {
        ...
        public static IEnumerable<IEnumerable<Move>> GetTargetVectors(Position position)
        {
            ...
            if (position.Piece.Color == PieceColor.White)
            {
                ...
                {
                    yield return new[] { new Move(position, new Square(6, 0), SpecialMove.CastleKing | SpecialMove.CannotTake, null, new Square(5, 0), new[] { new Square(5, 0), new Square(6, 0) }) };
                    yield return new[] { new Move(position, new Square(2, 0), SpecialMove.CastleQueen | SpecialMove.CannotTake, null, new Square(3, 0), new[] { new Square(2, 0), new Square(1, 0) }) };
                }
            }
            else
            {
                ...
                {
                    yield return new[] { new Move(position, new Square(6, 7), SpecialMove.CastleKing | SpecialMove.CannotTake, null, new Square(5, 7), new[] { new Square(5, 7), new Square(6, 7) }) };
                    yield return new[] { new Move(position, new Square(2, 7), SpecialMove.CastleQueen | SpecialMove.CannotTake, null, new Square(3, 7), new[] { new Square(2, 7), new Square(1, 7) }) };
                }
            }
        }
    }
