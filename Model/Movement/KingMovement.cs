    ...
    public static class KingMovement
    {
        ...
        public static IEnumerable<IEnumerable<Target>> GetTargetVectors(Square square, PieceColour pieceColour)
        {
            ...
            if (pieceColour == PieceColour.White)
            {
                ...
                {
                    yield return new[] { new Target(new Square(6, 0), SpecialMove.CastleKing | SpecialMove.CannotTake, new Square(5, 0)) };
                    yield return new[] { new Target(new Square(2, 0), SpecialMove.CastleQueen | SpecialMove.CannotTake, new Square(3, 0)) };
                }
            }
            else
            {
                ...
                {
                    yield return new[] { new Target(new Square(6, 7), SpecialMove.CastleKing | SpecialMove.CannotTake, new Square(5, 7)) };
                    yield return new[] { new Target(new Square(2, 7), SpecialMove.CastleQueen | SpecialMove.CannotTake, new Square(3, 7)) };
                }
            }
        }
    }
